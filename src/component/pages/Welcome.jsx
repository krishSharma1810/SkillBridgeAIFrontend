      ...
      <>
        <div
          ...
          <div className="w-[80rem] h-40 relative">
            ...
            <div
              className="absolute inset-x-60 top-0 bg-gradient-to-r from-transparent via-sky-500 to-transparent h-[5px] w-3/4 blur-sm" />
            <div
              className="absolute inset-x-60 top-0 bg-gradient-to-r from-transparent via-sky-500 to-transparent h-px w-3/4" />
          ...
          <div className="felx mt-5">
            <WelcomeButton name="Start Exploring" />
